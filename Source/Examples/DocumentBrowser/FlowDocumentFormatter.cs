namespace DocumentBrowser
{
    ...
    public class FlowDocumentFormatter : LynxToolkit.Documents.DocumentFormatter
    {
        ...
        public FlowDocumentFormatter(LynxToolkit.Documents.Document doc)
            : base(doc)
        {
        ...
        private Style Format(LynxToolkit.Documents.Style style)
        {
            ...
            Style s;
            if (styles.TryGetValue(style, out s))
                return s;
            s = CreateStyle(style);
            styles[style] = s;
            return s;
        ...
        private Style CreateStyle(LynxToolkit.Documents.Style style)
        {
            var s = new Style();
        ...
        private Thickness ToThickness(LynxToolkit.Documents.Thickness t)
        {
            return new Thickness(t.Left, t.Top, t.Right, t.Bottom);
        }

        private Brush ToBrush(LynxToolkit.Documents.Color c)
        {
