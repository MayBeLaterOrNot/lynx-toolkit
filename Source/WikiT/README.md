...
WikiT [/input=folder/search-pattern] [/format=html] [/output=folder] [/forceoutput] 
  ...
  /format        Specifies the output format. The default value is "html".
  /output        Specifies the output folder. The default value is "output".
  /forceoutput   Forces all output files to be generated.
  /extension     Specifies the output extension.
