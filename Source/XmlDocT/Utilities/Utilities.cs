namespace XmlDocT
{
    ...
    public static class Utilities
    {
        ...
        /// <param name="includeNames">include parameter names if set to <c>true</c>.</param>
        /// <returns>
        ...
        /// <summary>
        /// Gets the remarks for the specified member.
        /// </summary>
        /// <param name="xmldoc">The xml document.</param>
        /// <param name="memberName">Name of the member.</param>
        ...
        public static string GetInformation(string block, XmlDocument xmldoc, string memberName)
        {
            var node = xmldoc.SelectSingleNode("/doc/members/member[@name='" + memberName + "']")
                       ?? xmldoc.SelectSingleNode("/doc/members/member[starts-with(@name,'" + memberName + "')]");
